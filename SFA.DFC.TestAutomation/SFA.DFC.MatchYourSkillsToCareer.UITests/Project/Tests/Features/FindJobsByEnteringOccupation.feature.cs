...
namespace SFA.DFC.MatchYourSkillsToCareer.UITests.Project.Tests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("FindJobsByEnteringOccupation")]
    public partial class FindJobsByEnteringOccupationFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "FindJobsByEnteringOccupation.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "FindJobsByEnteringOccupation", "\tAs a citizen \r\n\tI would like to see Jobs suitable for me\r\n\tBy entering a desired" +
                    " occupation\r\n\tAnd seleting skills associated with that occupation", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Use Match Skills To Find Jobs by Entering Occupation")]
        [NUnit.Framework.CategoryAttribute("MatchSkills")]
        [NUnit.Framework.CategoryAttribute("Smoke")]
        public virtual void UseMatchSkillsToFindJobsByEnteringOccupation()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Use Match Skills To Find Jobs by Entering Occupation", null, new string[] {
                        "MatchSkills",
                        "Smoke"});
#line 9
...
#line 11
 testRunner.When("I select the search jobs by entering your job title option", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 12
